...
Badges and leaderboards are entirely for momentary pride.
...
#### It's hot/windy/raining/snowing
...
Drop the `-s` from the "tu" ending.

#### Formal

Swap the '-e' or '-a-' `usted` ending to '-a-' or '-e', respectfully.

## Section 3 Unit 10

### Self-Reflective Verbs
...
### Attach object pronouns to commands

### More direct than 'will' or 'can' which is polite
...
Must include **no** for the following:
...
> El no compro ningunas

\* If one of these is the subject *before* the verb, **no** is not required.

> Nadie tiene dinero

## Section 3 Unit 23

### Verbs ending in -gir or -ger
...
### Avoid repetition using 'el'/'la' vs. 'one' which in English
...
### Past tense of `ir` and `ser` are the same!
...
### 'Practicar', 'Buscar' and `Tocar` in singular past tense
